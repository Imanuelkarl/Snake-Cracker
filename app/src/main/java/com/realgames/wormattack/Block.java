...
public class Block extends Sprite
{
	...
	public void put(Canvas canvas)
	{
		...
		boundLeft.bottom=this.getCenterY()+this.getHeight()/2-this.getHeight()/8;
		...
		boundRight.bottom=this.getCenterY()+this.getHeight()/4-this.getHeight()/8;
		// TODO: Implement this method
		super.put(canvas);
		batch.drawText(this,score);
	}
}
